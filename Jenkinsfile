        ...
        stage('Checkout') {
            steps {
                script {
                    ...
                    checkout([$class: 'GitSCM', branches: [[name: "*/${pullRequestBranch}"]], userRemoteConfigs: [[url: 'https://github.com/program-training/class-3-finalProject-store-back.git']]])
                }
            }
        }
        ...
        success {
            script {
                ...
                setGitHubPullRequestStatus(
                    state: 'SUCCESS',
                    context: 'class3_store_back_lint',
                    message: 'lint passed',
                )
            }
        }
